...
public class VehicleDetailScreen extends JFrame {
    ...
    private void initializeUI() { //
        ...
        deleteButton = new JButton("Excluir Veículo"); // // Inicializa para que possa ser referenciado

        infoAndRentPanel.add(actionButton); //
        // O deleteButton será adicionado ou não dependendo do updateStatusLabel()
        // infoAndRentPanel.add(deleteButton); // Removido daqui, será gerenciado em updateStatusLabel()
